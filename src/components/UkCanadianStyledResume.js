...
const UkCanadianStyledResume = ({ user }) => {
    ...
    const handlePreviewSummary = () => {
        ...
        history.push('/summary', {
            title: "UK/Canadian Styled Resume",
            personalData,
        ...
        <div className='container'>
            ...
            <div className="form-container">
                ...
                <div>
                    ...
                    {otherInfo.financialSupport} {(e) => setOtherInfo({ ...otherInfo, financialSupport: e.target.value })}

                    {otherInfo.homeTies} {(e) => setOtherInfo({ ...otherInfo, homeTies: e.target.value })}

                    {otherInfo.futureProspect} {(e) => setOtherInfo({ ...otherInfo, futureProspect: e.target.value })}
...
export default UkCanadianStyledResume;
